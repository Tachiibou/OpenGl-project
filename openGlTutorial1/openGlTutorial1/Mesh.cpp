...
Mesh::Mesh(VertexInfo* vertexInfo, unsigned int numVertices, int indices[], int numIndices)
{
	...
	glBindBuffer(GL_ARRAY_BUFFER, m_vertexArrayBuffers[POSITION_VB]);
	glBufferData(GL_ARRAY_BUFFER, numVertices*sizeof(vertexInfo[0]), vertexInfo, GL_STATIC_DRAW);
